    ...
    return (
        <>
            <Header
                ...
                subtitle="Scegli il pacchetto di crediti adatto alle tue esigenze!"
            />
            ...
            <section>
                <ul className="mt-11 grid grid-cols-1 gap-5 sm:grid-cols-2 md:gap-9 xl:grid-cols-3">
                    {plans.map((plan) => (
                        <li
                            key={plan.name}
                            className="w-full rounded-[16px] border-2 border-purple-200/20 bg-violet-950 p-8 shadow-xl shadow-purple-200/20 lg:max-w-none"
                        >
